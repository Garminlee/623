window.addEventListener('load', function() {
    ...
    document.addEventListener('scroll', function() {
        ...
        if (window.pageYOffset > H_h1) {
            service.className = 'service container clearfix margin0';
        }
        if (window.pageYOffset > wrapper.clientHeight) {
            caseone.className = 'Caseone container clearfix margin15';
        }
        if (window.pageYOffset > H_h2) {
            cases.className = 'cases container margin0';
        }
        if (window.pageYOffset > H_h3) {
            clients.className = 'clients container margin0';
        }
        if (window.pageYOffset > H_h4) {
            opinions.className = 'opinions container margin0';
        }
        if (window.pageYOffset > H_h5) {
            footer.className = 'container clearfix margin0';
        }
        // 头部透明度
